...
제목용 고딕 **[서초돋움 (Seocho Dotum)](https://github.com/iwantanid/SeochoDotum-Font)** —
판결문 표제의 고딕 인상을 오마주한 무료 제목용 서체입니다.
서초바탕과 수직 메트릭을 공유하도록 설계되어, 제목은 서초돋움,
본문은 서초바탕으로 쓰면 판결문 지면의 호흡이 그대로 완성됩니다.
